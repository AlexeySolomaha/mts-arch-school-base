...
class Presentation_With_Author(object):
    ...
    def __init__(self, title, date, author):        
        self.title = title
        self.date = date
        # Добавил данные об авторе в DTO интерграционного сервиса. Фамилия среди данных есть.
        self.author = author
    pass
pass
...
async def read_presentation(title: str):
    ...
    presentationWithAuthor = Presentation_With_Author(presentation.title,  presentation.date, author)
